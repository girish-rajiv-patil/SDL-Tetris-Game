...
bool CFramework::Init(int ScreenWidth, int ScreenHeight, int ColorDepth, bool bFullscreen)
{
	...
	SDL_WM_SetCaption("Simple Tetris Game - Girish Patil", "Simple Tetris Game - Girish Patil");
...
//	font = TTF_OpenFont("../FreeSans.ttf", 24); 
	font = TTF_OpenFont("../Allema.ttf", 24); 
    ...
    SDL_Color color1 = {255, 32, 7};
    SDL_Color color = {255, 255, 255};
	text_color = color; 
   	TTF_RenderText_Solid(font, "Made by : Girish Patil", text_color);
    m_ptext_points = TTF_RenderText_Solid(font, "Points: ", color1);
...
{
	SDL_FillRect (m_pScreen, NULL, SDL_MapRGB (m_pScreen->format, 102, 90, 90));
}
